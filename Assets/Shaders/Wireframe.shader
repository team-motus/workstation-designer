// Modified Wireframe shader by Chaser324 with Unity Standard shader to add wireframe to object
...
Shader "Custom/Wireframe"
{
	Properties
	{
		...
		_WireThickness ("Wire Thickness", RANGE(0, 800)) = 500
		_WireSmoothness ("Wire Smoothness", RANGE(0, 20)) = 3
		_WireColor ("Wire Color", Color) = (1.0, 1.0, 0.0, 1.0)
	...
	SubShader
    {
		...
		Pass
		{
			...
			uniform float4 _BaseColor = float4(1.0, 0.0, 0.0, 1.0);
